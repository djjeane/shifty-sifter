...
module.exports = {
	...
	async execute(interaction) {
		...
		{
			setTimeout(() => {
				interaction.channel.send(`You WON and trippled your bet! Gained ${wager * 3} points!`);
		...
		else
		{
			setTimeout(() => 
			{
				interaction.channel.send(`You LOST and lost your bet! Lost ${wager} points! \n `);
