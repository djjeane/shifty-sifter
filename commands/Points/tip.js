...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addIntegerOption((option) =>
      option
        .setName("amounttotip")
        .setDescription("Enter a number of points to give.")
    )
  ...
  async execute(interaction) {
    ...
    if (toUser.id == interaction.member.user.id) {
      interaction.editReply(
        `You cant give yourself points. You think your shit dont stink huh? -5 points.`
      );
    ...
    } has given ${toUser} ${amountToTip} points! Say Thanks.
