...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (outcome == userChoice) {
            ...
            gainedPoints -= wager;
            await interaction.editReply({ content: `Not this time, unfortunately you guessed incorrectly. You lost ${Math.abs(gainedPoints)} Points! You currently have ${points+gainedPoints}.`});
        }
